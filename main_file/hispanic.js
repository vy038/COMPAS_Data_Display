/**
 * This class creates a person (dot) of hispanic ethnicity at a specific place which has certain methods, including updating and having various properties
 * @class  
 */
class Hispanic extends Person {
	/**
