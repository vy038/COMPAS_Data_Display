/**
 * This class creates a person (dot) of asian ethnicity at a specific place which has certain methods, including updating and having various properties
 * @class  
 */
class Asian extends Person {
	...
	show() {
		...
		triangle(this.x, this.y + 1, this.x + 0.7, this.y + 0.7, this.x-0.7, this.y-0.7);
	}
