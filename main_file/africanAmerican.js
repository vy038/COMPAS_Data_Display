/**
 * This class creates a person (dot) of african american ethnicity at a specific place which has certain methods, including updating and having various properties
 * @class  
 */
class AfricanAmerican extends Person {
	 ...
	 */
	updateMaritalToggle(maritalToggle) {
		this.maritalToggle = maritalToggle;
	}
